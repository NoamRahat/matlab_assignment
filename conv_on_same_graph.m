...
% subplot(2,1,1);
% hold on;
% plot(y1_linear, 'r', 'DisplayName', 'Linear Convolution');
% plot(y1_ova, 'b', 'DisplayName', 'OVA Convolution');
% title('Filter 1');
% legend('show');
% hold off;
% 
% subplot(2,1,2);
% hold on;
% plot(y2_linear, 'r', 'DisplayName', 'Linear Convolution');
% plot(y2_ova, 'b', 'DisplayName', 'OVA Convolution');
% title('Filter 2');
% legend('show');
% hold off;
% 
...
% subplot(2,1,1);
% hold on;
% plot(zoom_start:zoom_end, y1_linear(zoom_start:zoom_end), 'r', 'DisplayName', 'Linear Convolution');
% plot(zoom_start:zoom_end, y1_ova(zoom_start:zoom_end), 'b', 'DisplayName', 'OVA Convolution');
...
% subplot(2,1,2);
% hold on;
% plot(zoom_start:zoom_end, y2_linear(zoom_start:zoom_end), 'r', 'DisplayName', 'Linear Convolution');
% plot(zoom_start:zoom_end, y2_ova(zoom_start:zoom_end), 'b', 'DisplayName', 'OVA Convolution');
...
subplot(2,1,1);
hold on;
plot(y1_linear, 'r', 'DisplayName', 'Linear Convolution', 'LineWidth', 1.5);
plot(y1_ova, 'b--', 'DisplayName', 'OVA Convolution', 'LineWidth', 1.5);
title('Filter 1');
legend('show');
hold off;
...
subplot(2,1,2);
hold on;
plot(y2_linear, 'r', 'DisplayName', 'Linear Convolution', 'LineWidth', 1.5);
plot(y2_ova, 'b--', 'DisplayName', 'OVA Convolution', 'LineWidth', 1.5);
title('Filter 2');
legend('show');
hold off;
